...
function App() {
  const lignes = [
    ...
    { id: 7,  numero: "31", depart: "Fann",               arrivee: "HLM",         arrets: 9,  couleur: "#27ae60" },
    { id: 8,  numero: "42", depart: "Liberté",            arrivee: "Medina",      arrets: 13, couleur: "#f39c12" },
    { id: 9,  numero: "18", depart: "Dieuppeul",          arrivee: "Sandaga",     arrets: 15, couleur: "#2980b9" },
    { id: 10, numero: "25", depart: "Sicap",              arrivee: "Colobane",    arrets: 11, couleur: "#c0392b" },
